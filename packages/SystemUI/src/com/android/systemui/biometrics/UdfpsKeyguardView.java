...
public class UdfpsKeyguardView extends UdfpsAnimationView {
    ...
    public UdfpsKeyguardView(Context context, @Nullable AttributeSet attrs) {
        ...
        mPackageInstalled = com.android.internal.util.arrow.systemUtils.isPackageInstalled(
                mContext, "com.arrow.udfps.icons");
    }
    ...
    private void updateBurnInOffsets() {
        ...
        if (mAnimationType == ANIMATION_BETWEEN_AOD_AND_LOCKSCREEN && !mPauseAuth) {
            ...
            mLockScreenFp.setAlpha(mCustomUdfpsIcon ||
                  (!TextUtils.isEmpty(customIconURI) && mCustomFpIconEnabled) ? 0.0f : (mAlpha / 255f));
        } else {
